...
const Shopall = () => {
  ...
  <div className='flex flex-col sm:flex-row gap-4 sm:gap-10'>
    ...
    <div className="product m-4 sm:m-2 sm:mr-5 sm:w-full">
      <div>
        {/* Section Title */}
        <h1 className="text-2xl sm:text-4xl font-bold text-center sm:text-left">All Products</h1>
        ...
        {/* Product Count */}
        <div className={` ${countValue} text-md mt-4 text-center sm:text-left`}>{count} Products</div>

        {/* Products Grid */}
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 sm:gap-5 mt-5">
          {products
            .filter((product) => {
              if (search === '') {
                return product;
